...
- [`crates/topcoat-router/docs/strip_prefix.md`](crates/topcoat-router/docs/strip_prefix.md): `StripPrefixLayer`, a layer that removes a URI path prefix before inner layers and the route run.
